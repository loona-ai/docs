...
- Далее заполняем детали всех имеющихся уровней скидок в кабинете, и **называем их так же как и были названы соответствующие уровни скидок в iiko office**
...
- Ставим галочку "Только для сотрудников"
