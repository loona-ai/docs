...
- Далее заполняем детали всех имеющихся уровней скидок в кабинете, и **называем их так же как названы соответствующие уровни скидок в iiko office** (Настройки создания скидки в iiko office ниже)
