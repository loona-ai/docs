...
Для того чтобы отправить уже созданую карту, можно скопировать её ссылку, отправить её по СМС и по электронной почте. Методы отправки карты доступны в поле **Поделиться** в нижнейчасти Профиля Карты.
