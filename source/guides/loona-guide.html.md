...
Для настройки уведомления пройдите в **Макеты->Редактирование->Дизайн**. Далее, выберите поле на дизайне карты в котором содержится переменная. В настройках поля будет текстовая строка "Текст об изменениях", напишите там текст уведомления при изменении переменной которая находится в том поле. В тексте уведомления **обязательно** должны присутствовать символы **"%@"**, на месте этих символов будет отображаться значение переменной!
