...
- Зайдите в <img src="" width="12" height="12" alt="редактирование"> **редактирование** того макета на который хотите настроить сканер
...
# Личный кабинет (Настройки профиля пользователя)
