...
На левой стороне страницы находится телефон в котором отображаются все внесенные изменения. Добавляйте информацию непосредственно на предпросмотр карты.
