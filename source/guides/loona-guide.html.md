...
Изучение руковосдтва поможет вам научиться пользованию нашим приложением. Руководство содержит инструкции по созданию макетов, редактированию макетов, регистрации пользователей, настройках систем лояльноски, настройках Гео-уведомлений и PUSH-уведомлений, созданию и распространению карт, созданию и пользованию сканерами и т.д.
...
Выбрать сертификат которым вы будете пользоваться. Сертификат можно загрузить в личном кабинете, **настройки -> сертификат**. 
...
На левой стороне страницы находится телефон в котором отоброжаются все внесенные изменения. Добавляйте информацию непосредственно на предосмотр карты.
...
При выборе информационного поля открывается секция "настройки поля", отличающиеся при разных полях и типах карт. В настройках поля можно настроить формат и выравнивать текст. Также в настройках поля можете внести текст уведомления, которое будет получать владелец карты при внесеннии изменений по выбранной переменной.
...
Здесь вы можете настроить максимально возможный процент оплаты чека бонусами в поле *Максимальный Процент*. Приветственный бонус и срок его действия можно ввести в секции *Приветственный Бонус*, этот бонус прибавляется к бонусным накоплениям при добавлении карты пользователем и доступен к использованию на протяжении срока действия. 

Процент накоплений можно менять в разделе “Уровни”. Если в разделе “Уровни” добавить уровень, можно указать пороговое значение общей суммы покупок клиента, при достижении которых, он автоматически перейдет на другой уровень с более высоким процентом скидки.

**Скидочная система:**

Приветственную скидку и срок её действия можно ввести в секции *Приветственная скидка*, это скидка на первую покупку после добавления карты пользователем и она доступна к использованию на протяжении срока действия. 

Проценты скидкок можно менять в разделе “Уровни”. Если в разделе “Уровни” добавить уровень, можно указать пороговое значение общей суммы покупок клиента, при достижении которых, он автоматически перейдет на другой уровень с более высоким процентом скидки.
...
Для того чтобы отправить уже созданую карту, можно скопировать её ссылку, отправить её по СМС и по электронной почте. Методы отправки карты доступны в поле **"Поделиться"** в нижней части Профиля Карты.
...
Настройка гео-уведомлений доступна при [редактировании макета](https://docs.loona.ai/guides/loona-guide.html#6e3f1ab769).
