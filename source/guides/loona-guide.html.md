...
При наличии динамичной переменной на карте, в случае её изменений можно автоматически отправлять уведомление пользователю. (Например: при наличии на карте суммы покупок, после ) 
