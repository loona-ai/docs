...
Процент накоплений и пороговые значения можно менять в разделе “Уровни”. Если в разделе “Уровни” добавить уровень, можно указать пороговое значение общей суммы покупок клиента, при достижении которых, он автоматически перейдет на другой уровень с более высоким процентом бонусных накоплений.
